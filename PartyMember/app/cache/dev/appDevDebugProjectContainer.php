...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ibw.partymember.admin.applypartymember' => 'getIbw_Partymember_Admin_ApplypartymemberService',
            'ibw.partymember.admin.partymember' => 'getIbw_Partymember_Admin_PartymemberService',
            'ibw.partymember.admin.partymemberbranch' => 'getIbw_Partymember_Admin_PartymemberbranchService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('E:/workspace/git/PartyMember/PartyMember/app/cache/dev/assetic/config'), true)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'PartyMember', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_c7741e4697ff49b415f90fc62fffd9f8ce7d183e61026af93298e13d859d4004');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_c7741e4697ff49b415f90fc62fffd9f8ce7d183e61026af93298e13d859d4004');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_c7741e4697ff49b415f90fc62fffd9f8ce7d183e61026af93298e13d859d4004');
        ...
        $f->setEntityNamespaces(array('IbwPartymemberBundle' => 'Ibw\\PartymemberBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('E:/workspace/git/PartyMember/PartyMember/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'ibw.partymember.admin.applypartymember' service.
     *
     * @return Ibw\PartymemberBundle\Admin\ApplyPartymemberAdmin A Ibw\PartymemberBundle\Admin\ApplyPartymemberAdmin instance.
     */
    protected function getIbw_Partymember_Admin_ApplypartymemberService()
    {
        $instance = new \Ibw\PartymemberBundle\Admin\ApplyPartymemberAdmin('ibw.partymember.admin.applypartymember', 'Ibw\\PartymemberBundle\\Entity\\ApplyPartymember', 'IbwPartymemberBundle:ApplyPartymemberAdmin');
    ...
    /**
     * Gets the 'ibw.partymember.admin.partymember' service.
     *
     * @return Ibw\PartymemberBundle\Admin\PartymemberAdmin A Ibw\PartymemberBundle\Admin\PartymemberAdmin instance.
     */
    ...
    /**
     * Gets the 'ibw.partymember.admin.partymemberbranch' service.
     *
     * @return Ibw\PartymemberBundle\Admin\PartymemberBranchAdmin A Ibw\PartymemberBundle\Admin\PartymemberBranchAdmin instance.
     */
    protected function getIbw_Partymember_Admin_PartymemberbranchService()
    {
        $instance = new \Ibw\PartymemberBundle\Admin\PartymemberBranchAdmin('ibw.partymember.admin.partymemberbranch', 'Ibw\\PartymemberBundle\\Entity\\PartymemberBranch', 'IbwPartymemberBundle:PartymemberBranchAdmin');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('E:/workspace/git/PartyMember/PartyMember/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:E:/workspace/git/PartyMember/PartyMember/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '/admin'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('E:/workspace/git/PartyMember/PartyMember/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('E:/workspace/git/PartyMember/PartyMember/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('E:/workspace/git/PartyMember/PartyMember/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'ibw.partymember.admin.partymember', 1 => 'ibw.partymember.admin.applypartymember', 2 => 'ibw.partymember.admin.partymemberbranch'));
        $instance->setAdminGroups(array('管理' => array('label' => '管理', 'label_catalogue' => 'SonataAdminBundle', 'roles' => array(), 'items' => array(0 => 'ibw.partymember.admin.partymember', 1 => 'ibw.partymember.admin.applypartymember', 2 => 'ibw.partymember.admin.partymemberbranch'))));
        $instance->setAdminClasses(array('Ibw\\PartymemberBundle\\Entity\\Partymember' => array(0 => 'ibw.partymember.admin.partymember'), 'Ibw\\PartymemberBundle\\Entity\\ApplyPartymember' => array(0 => 'ibw.partymember.admin.applypartymember'), 'Ibw\\PartymemberBundle\\Entity\\PartymemberBranch' => array(0 => 'ibw.partymember.admin.partymemberbranch')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'ibw.partymember.admin.partymember', 1 => 'ibw.partymember.admin.applypartymember', 2 => 'ibw.partymember.admin.partymemberbranch'), $this);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/translations', 'debug' => true));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('E:\\workspace\\git\\PartyMember\\PartyMember\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('E:\\workspace\\git\\PartyMember\\PartyMember\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('E:\\workspace\\git\\PartyMember\\PartyMember\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('826ea39f7a0f36895b989175b1756210f9ba7c51');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'E:/workspace/git/PartyMember/PartyMember/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('E:/workspace/git/PartyMember/PartyMember/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev',
            ...
            'kernel.bundles' => array(
                ...
                'IbwPartymemberBundle' => 'Ibw\\PartymemberBundle\\IbwPartymemberBundle',
            ...
            'locale' => 'en',
            'secret' => '826ea39f7a0f36895b989175b1756210f9ba7c51',
            ...
            'debug.container.dump' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '826ea39f7a0f36895b989175b1756210f9ba7c51',
            ...
            'session.save_path' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:E:/workspace/git/PartyMember/PartyMember/app/cache/dev/profiler',
            ...
            'router.resource' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'E:/workspace/git/PartyMember/PartyMember/app/cache/dev/doctrine/orm/Proxies',
